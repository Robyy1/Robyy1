...
const upgrades = [
  // Good upgrades
  {
    ...
    type: "good",
    icon: "🔪",
    description: "Your beak becomes razor sharp, increasing damage per hit.",
    effect: "+25% DAMAGE",
    cost: 0,
    apply: () => {
      player.damage *= 1.25;
  ...
  },
  {
    ...
    type: "good",
    icon: "❤️",
    description: "Your blood thickens, increasing your maximum health.",
    effect: "+40 MAX HEALTH",
    cost: 0,
    apply: () => {
      player.maxHealth += 40;
  ...
  },
  {
    ...
    type: "good",
    icon: "🕊️",
    description: "Your wings grow stronger, increasing your movement speed.",
    effect: "+30% SPEED",
    cost: 0,
    apply: () => {
      player.speed *= 1.3;
  ...
  },
  {
    ...
    type: "good",
    icon: "⚡",
    description: "Your pecking speed increases dramatically.",
    effect: "+40% FIRE RATE",
    cost: 0,
    apply: () => {
      player.fireRate *= 1.4;
  ...
  },
  {
    ...
    type: "good",
    icon: "🎯",
    description: "Your attacks split into multiple projectiles.",
  ...
  },
  {
    ...
    type: "good",
    icon: "🧛",
    description: "You drain more life from your enemies.",
    effect: "+15% LIFE STEAL",
    cost: 0,
    apply: () => {
  ...
  },
  {
    ...
    type: "good",
    icon: "💥",
    description: "Your projectiles explode on impact, damaging nearby enemies.",
    effect: "AREA DAMAGE: 15 in 60 radius",
    cost: 0,
    apply: () => {
      player.explosionRadius = 60;
      player.explosionDamage = 15;
    },
  },
  {
    id: "pierce_1",
    ...
    type: "good",
    icon: "🗡️",
    description: "Your projectiles can now pierce through multiple enemies.",
    effect: "PROJECTILES PIERCE 2 ENEMIES",
    cost: 0,
    apply: () => {
  ...
  },
  {
    ...
    icon: "🔫",
    description:
      "A magical cannon appears on your back, shooting backward automatically.",
    effect: "AUTOMATIC REAR ATTACK",
    cost: 0,
    apply: () => {
      player.rearCannon = true;
    },
  },
  {
    id: "side_cannons",
    ...
    icon: "🔫",
    description:
      "Magical cannons appear on your sides, shooting left and right automatically.",
    effect: "AUTOMATIC SIDE ATTACKS",
    cost: 0,
    apply: () => {
      player.sideCannons = true;
    },
  },
  ...
  // Bad upgrades (with trade-offs)
  {
    ...
    icon: "⬇️",
    description:
      "Your beak becomes heavier and more damaging, but slows you down.",
    effect: "+35% DAMAGE, -25% SPEED",
    cost: 0,
    apply: () => {
      player.damage *= 1.35;
      player.speed *= 0.75;
  ...
  },
  {
    ...
    icon: "⬇️",
    description:
      "Your heart pumps faster, increasing fire rate but reducing maximum health.",
    effect: "+50% FIRE RATE, -30 MAX HEALTH",
    cost: 0,
    apply: () => {
      player.fireRate *= 1.5;
      player.maxHealth = Math.max(50, player.maxHealth - 30);
      player.health = Math.min(player.health, player.maxHealth);
    },
  },
  {
    id: "projectiles_damage",
    name: "Scatter Shot",
    type: "bad",
    icon: "⬇️",
    description:
      "Your shots scatter in many directions, but each deals less damage.",
    effect: "+4 PROJECTILES, -30% DAMAGE PER SHOT",
    cost: 0,
    apply: () => {
      player.projectileCount += 4;
      player.damage *= 0.7;
    },
  },
  {
    ...
    type: "bad",
    icon: "⬇️",
    description: "You become lighter and faster, but your attacks are weaker.",
    effect: "+40% SPEED, -25% DAMAGE",
    cost: 0,
    apply: () => {
      player.speed *= 1.4;
      player.damage *= 0.75;
  ...
  },
  {
    ...
    icon: "⬇️",
    description:
      "You become obsessed with blood, increasing life steal but reducing movement speed.",
    effect: "+25% LIFE STEAL, -30% SPEED",
    cost: 0,
    apply: () => {
  ...
  // Neutral/interesting upgrades
  {
    ...
    icon: "🔥",
    description:
      "Your explosive shots now have a larger radius of destruction.",
    effect: "+30 EXPLOSION RADIUS",
    cost: 0,
    apply: () => {
  ...
  {
    id: "explosion_damage",
    name: "Hotter Explosion",
    type: "neutral",
    icon: "🔥",
    description: "Your explosive shots deal more damage to nearby enemies.",
    effect: "+10 EXPLOSION DAMAGE",
    cost: 0,
    apply: () => {
      player.explosionDamage += 10;
    },
  },
  {
    id: "projectile_speed",
    ...
    type: "neutral",
    icon: "💨",
    description: "Your projectiles travel faster, making them harder to dodge.",
    effect: "+50% PROJECTILE SPEED",
    cost: 0,
    apply: () => {},
  }, // Handled in shoot function
  {
    ...
    type: "neutral",
    icon: "♻️",
    description: "Your vampiric blood slowly regenerates over time.",
    effect: "HEALTH REGEN: 0.5 HP/S",
    cost: 0,
    apply: () => {},
  }, // Handled in game loop
  {
    ...
    icon: "🎯",
    description:
      "Sometimes your attacks hit critical spots for massive damage.",
    effect: "15% CRIT CHANCE (+100% DAMAGE)",
    cost: 0,
    apply: () => {},
...
const shopItems = [
  {
    ...
    name: "Enchanted Beak",
    price: 15,
    description: "Magical enchantment that permanently increases your damage.",
    effect: "+20% DAMAGE",
    apply: () => {
      player.damage *= 1.2;
    },
  },
  {
    ...
    name: "Vampire Heart",
    price: 20,
    description: "A powerful vampire heart that increases your maximum health.",
  ...
  },
  {
    ...
    name: "Quick Blood",
    price: 18,
    description: "Your blood flows faster, increasing attack speed.",
    effect: "+30% FIRE RATE",
    apply: () => {
      player.fireRate *= 1.3;
    },
  },
  {
    ...
    name: "Split Beak",
    price: 25,
    description: "Your attacks magically split into more projectiles.",
    effect: "+1 PROJECTILE",
    apply: () => {
  ...
  },
  {
    ...
    price: 30,
    description:
      "Magical glands that make your shots explode with greater force.",
    effect: "+15 EXPLOSION DAMAGE",
    apply: () => {
      player.explosionDamage += 15;
    },
  },
  {
    ...
    name: "Blood Amulet",
    price: 22,
    description: "An amulet that enhances your life-stealing abilities.",
    effect: "+12% LIFE STEAL",
    apply: () => {
      player.lifeSteal += 0.12;
    },
  },
  {
    id: "speed_plus",
    name: "Wind Feathers",
    price: 16,
    description: "Magical feathers that make you faster.",
    effect: "+25% SPEED",
    apply: () => {
      player.speed *= 1.25;
    },
  },
  {
    ...
    price: 28,
    description:
      "Magical armor made of hardened feathers that reduces damage taken.",
  ...
  }, // Handled in damage calculation
  {
    ...
    price: 24,
    description:
      "Your aim improves, giving you a better chance to land critical hits.",
...
const bosses = [
  {
    ...
    description:
      "A massive golem made of congealed blood. It charges at you when enraged!",
  },
  {
...
window.addEventListener("resize", () => {
  ...
  if (gameState.current === "playing") {
    player.x = Math.min(
      Math.max(player.x, player.radius),
      canvas.width - player.radius,
    );
    player.y = Math.min(
      Math.max(player.y, player.radius),
...
function startWave() {
  ...
  if (gameState.currentWave % 5 === 0) {
    ...
    const bossIndex = Math.min(
      Math.floor(gameState.currentWave / 5) - 1,
      bosses.length - 1,
    );
...
function spawnEnemies(count) {
  ...
  for (let i = 0; i < count; i++) {
    if (
      gameState.enemiesKilled + gameState.enemiesAlive >=
    ...
    const postBossMultiplier =
      gameState.currentWave > 5 && (gameState.currentWave - 1) % 5 === 0
        ? 1.8
        : 1.0;
...
function updateExperienceBar() {
  ...
  const progressPercent =
    (gameState.enemiesKilled / gameState.enemiesToSpawn) * 100;
...
function showUpgradeScreen() {
  ...
  if (goodUpgrades.length > 0 && Math.random() > 0.3) {
    const randomGood =
      goodUpgrades[Math.floor(Math.random() * goodUpgrades.length)];
  ...
  if (gameState.running) {
    ...
    for (let i = projectiles.length - 1; i >= 0; i--) {
      ...
      for (let j = enemies.length - 1; j >= 0; j--) {
        ...
        if (distance < e.radius + p.radius) {
          ...
          const damageAmount = isCritical
            ? Math.round(p.damage * 2)
            : Math.round(p.damage);
            ...
            for (let k = enemies.length - 1; k >= 0; k--) {
              ...
              if (dist < p.explosionRadius + e2.radius) {
                const explosionDamage =
                  p.explosionDamage * (1 - dist / p.explosionRadius);
      ...
      if (gameState.boss && !gameState.boss.isDead) {
        ...
        if (distance < gameState.boss.radius + p.radius) {
          ...
          createDamageText(
            gameState.boss.x,
            gameState.boss.y - gameState.boss.radius,
            Math.round(p.damage),
            false,
          );
    ...
    if (gameState.boss && !gameState.boss.isDead) {
      ...
      if (gameState.boss.attackPattern === "charge") {
        ...
        if (
          gameState.boss.health < gameState.boss.enrageThreshold &&
        ...
        const playerDist = Math.sqrt(
          (player.x - gameState.boss.x) ** 2 +
            (player.y - gameState.boss.y) ** 2,
        );
        if (playerDist < player.radius + gameState.boss.radius) {
          if (!player.invulnerable) {
            ...
            createDamageText(
              ...
              Math.round(gameState.boss.damage * 0.4),
              false,
            );
          }
          ...
          player.x = Math.max(
            padding,
            Math.min(canvas.width - padding, player.x),
          );
          player.y = Math.max(
            padding,
            Math.min(canvas.height - padding, player.y),
          );
        }
        ...
        const now = Date.now();
        if (
          now - gameState.boss.lastAttack > gameState.boss.attackCooldown &&
          Math.random() < 0.3
        ) {
        ...
        if (playerDist < player.radius + gameState.boss.radius + 100) {
          if (
            !player.invulnerable &&
            Date.now() - gameState.boss.lastAttack > 300
          ) {
            ...
            createDamageText(
              player.x,
              player.y - player.radius,
              Math.round(gameState.boss.damage * 0.3),
              false,
            );
      ...
      if (player.invulnerable && timestamp - player.invulnerableTime > 300) {
        // Reduced to 300ms
        player.invulnerable = false;
      }
    }
    ...
    for (let i = enemies.length - 1; i >= 0; i--) {
      ...
      for (let j = 0; j < enemies.length; j++) {
        ...
        if (distance > 0 && distance < e.radius + other.radius + 40) {
      ...
      if (
        ...
        if (
          (e.behavior === "mage" || e.behavior === "archer") &&
          distToPlayer < (e.attackRange || 250)
        ) {
          const now = Date.now();
        ...
        if (
          dist < 20 ||
          Math.hypot(e.target.x - player.x, e.target.y - player.y) > 200
        ) {
          e.target = null;
        }
    ...
    if (
      !gameState.isBossWave &&
      gameState.enemiesAlive < 20 &&
      gameState.enemiesKilled + gameState.enemiesAlive <
        gameState.enemiesToSpawn
    ) {
...
function drawGame() {
  ...
  if (gameState.boss && !gameState.boss.isDead) {
    ...
    if (gameState.boss.name === "Blood Golem") {
      ...
      ctx.arc(
        gameState.boss.x,
        gameState.boss.y + gameState.boss.radius * 0.3,
        gameState.boss.radius * 0.9,
        0,
        Math.PI * 2,
      );
      ctx.fill();
      ...
      ctx.beginPath();
      ctx.arc(
        gameState.boss.x - gameState.boss.radius * 1.4,
        gameState.boss.y,
        gameState.boss.radius * 0.7,
        0,
        Math.PI * 2,
      );
      ctx.arc(
      ...
      ctx.beginPath();
      ctx.arc(
        gameState.boss.x - gameState.boss.radius * 0.3,
        gameState.boss.y - gameState.boss.radius * 0.2,
        gameState.boss.radius * 0.2,
        0,
        Math.PI * 2,
      );
      ctx.arc(
      ...
      ctx.quadraticCurveTo(
        gameState.boss.x - gameState.boss.radius * 2,
        gameState.boss.y - gameState.boss.radius,
        gameState.boss.x - gameState.boss.radius * 0.8,
        gameState.boss.y + gameState.boss.radius * 0.8,
      );
      ctx.quadraticCurveTo(
        gameState.boss.x - gameState.boss.radius * 2,
        gameState.boss.y + gameState.boss.radius * 1.8,
        gameState.boss.x,
        gameState.boss.y,
      );
      ctx.fill();
      ...
      ctx.beginPath();
      ctx.moveTo(
        gameState.boss.x - gameState.boss.radius * 0.5,
        gameState.boss.y - gameState.boss.radius * 1.2,
      );
      ctx.lineTo(
        gameState.boss.x - gameState.boss.radius * 0.3,
        gameState.boss.y - gameState.boss.radius * 1.5,
      );
      ctx.lineTo(
        gameState.boss.x,
        gameState.boss.y - gameState.boss.radius * 1.3,
      );
      ctx.lineTo(
        gameState.boss.x + gameState.boss.radius * 0.3,
        gameState.boss.y - gameState.boss.radius * 1.5,
      ...
      ctx.beginPath();
      ctx.arc(
        gameState.boss.x - gameState.boss.radius * 0.25,
        gameState.boss.y - gameState.boss.radius * 0.4,
        gameState.boss.radius * 0.2,
        0,
        Math.PI * 2,
      );
      ...
      ctx.moveTo(
        gameState.boss.x + gameState.boss.radius * 0.8,
        gameState.boss.y + gameState.boss.radius * 0.5,
      );
      ctx.lineTo(
        gameState.boss.x + gameState.boss.radius * 1.8,
        gameState.boss.y + gameState.boss.radius * 1.5,
      );
      ctx.stroke();
      ...
      ctx.beginPath();
      ctx.arc(
        gameState.boss.x - gameState.boss.radius * 0.2,
        gameState.boss.y - gameState.boss.radius * 0.3,
        gameState.boss.radius * 0.15,
        0,
        Math.PI * 2,
      );
      ctx.arc(
    ...
    ctx.fillStyle = "#333";
    ctx.fillRect(
      gameState.boss.x - barWidth / 2,
      gameState.boss.y - gameState.boss.radius - 25,
      barWidth,
      barHeight,
    );
    ...
    ctx.fillText(
      gameState.boss.name,
      gameState.boss.x,
      gameState.boss.y - gameState.boss.radius - 35,
    );
  }
